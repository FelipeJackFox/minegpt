...
> remain valid; consolidated into `../pipeline/QA_GENERATION_PLAN.md`.
>
...
- `PHASE4_TRANSFORMATION_PLAN.md` — plan operacional completo (same directory)
- `../archive/CLASSIFIER_REDESIGN.md` — taxonomía cat-driven (archived; live code in `scraper/explore_subgroups.py`)
- `../pipeline/WIKI_DATA_CLEANING.md` — pipeline de Phases 1-3
- `raw_data/_archive/exploration/misclassifications.jsonl` — auditoría de 130 flags (archived)
